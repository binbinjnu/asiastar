...
encode_msg_c2s_test1(#c2s_test1{iValue = F1,
				sValue = F2, bValue = F3},
		     Bin, TrUserData) ->
...
dfp_read_field_def_c2s_test1(<<8, Rest/binary>>, Z1, Z2,
    ...
    d_field_c2s_test1_iValue(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
dfp_read_field_def_c2s_test1(<<18, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_c2s_test1_sValue(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
dfp_read_field_def_c2s_test1(<<26, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_c2s_test1_bValue(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
dfp_read_field_def_c2s_test1(<<>>, 0, 0, F@_1, F@_2,
			     F@_3, _) ->
    #c2s_test1{iValue = F@_1, sValue = F@_2, bValue = F@_3};
...
dg_read_field_def_c2s_test1(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_c2s_test1_iValue(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      18 ->
	  d_field_c2s_test1_sValue(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      26 ->
	  d_field_c2s_test1_bValue(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_c2s_test1(Rest, 0, 0, F@_1, F@_2, F@_3,
				      TrUserData);
	    1 ->
		skip_64_c2s_test1(Rest, 0, 0, F@_1, F@_2, F@_3,
				  TrUserData);
	    2 ->
		...
		skip_group_c2s_test1(Rest, Key bsr 3, 0, F@_1, F@_2,
				     F@_3, TrUserData);
	    5 ->
		skip_32_c2s_test1(Rest, 0, 0, F@_1, F@_2, F@_3,
				  TrUserData)
	  end
    end;
...
d_field_c2s_test1_iValue(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_c2s_test1_iValue(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
d_field_c2s_test1_iValue(<<0:1, X:7, Rest/binary>>, N,
...
d_field_c2s_test1_sValue(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_c2s_test1_sValue(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
d_field_c2s_test1_sValue(<<0:1, X:7, Rest/binary>>, N,
...
d_field_c2s_test1_bValue(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_c2s_test1_bValue(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
d_field_c2s_test1_bValue(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_c2s_test1(RestF, 0, 0, F@_1, F@_2,
				 NewFValue, TrUserData).

skip_varint_c2s_test1(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_c2s_test1(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			  TrUserData);
...
skip_group_c2s_test1(Bin, FNum, Z2, F@_1, F@_2, F@_3,
		     TrUserData) ->
...
merge_msg_c2s_test1(#c2s_test1{iValue = PFiValue,
			       sValue = PFsValue, bValue = PFbValue},
		    #c2s_test1{iValue = NFiValue, sValue = NFsValue,
			       bValue = NFbValue},
		    _) ->
    #c2s_test1{iValue =
...
v_msg_c2s_test1(#c2s_test1{iValue = F1, sValue = F2,
			   bValue = F3},
		Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_type_int32(F1, [iValue | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
       true -> v_type_string(F2, [sValue | Path], TrUserData)
    end,
    if F3 == undefined -> ok;
       true -> v_type_bytes(F3, [bValue | Path], TrUserData)
    end,
    ok;
...
get_msg_defs() ->
    [{{msg, c2s_test1},
      [#field{name = iValue, fnum = 1, rnum = 2, type = int32,
	      occurrence = optional, opts = []},
       #field{name = sValue, fnum = 2, rnum = 3, type = string,
	      occurrence = optional, opts = []},
       #field{name = bValue, fnum = 3, rnum = 4, type = bytes,
	      occurrence = optional, opts = []}]},
     {{msg, c2s_test2},
